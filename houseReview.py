...
def houseReviewMain():
    ...
    class Sound():
        ...
        hitSound = pygame.mixer.Sound(os.path.join("houseReviewData","sound","soundeffect2.wav"))
        lickSound = pygame.mixer.Sound(os.path.join("houseReviewData","sound","lickeffect.wav"))
        lickSound.set_volume(v*0.3)
        
        pygame.mixer.music.load(os.path.join("houseReviewData","sound","music.wav")) #must be wav 16bit and stuff?
