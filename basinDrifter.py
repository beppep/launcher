...
def basinDrifterMain():
    ...
    def loadImage(textureName, size=gridSize, convert=False):
        name = os.path.join("basinAssets/textures", textureName)
    ...
    class Chunk():
        ...
        def generateTiles(self):
            ...
            if(self.ends>0) or startOfGameChunk:
                ...
                img = Image.open("basinAssets/textures/blueprints/"+structure_name+".png")
                img.load()
    ...
    class Entity():
        ...
        def draw(self): 
            ...
            if hasattr(self, "max_health") and self.health < self.max_health/2:
