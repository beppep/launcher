...
def houseReviewMain():
    ...
    pygame.display.set_icon(pygame.image.load(os.path.join(filepath,"house","window.png")))
    ...
    def loadImage(name,r,r2=None):
        if not r2:
            r2=r
        image = pygame.image.load(os.path.join(filepath,name))
    ...
    class Sound():
        ...
        sweepSound = pygame.mixer.Sound(os.path.join(filepath,"sound","sweep.wav"))
        thudSound = pygame.mixer.Sound(os.path.join(filepath,"sound","thud.wav"))
        clickSound = pygame.mixer.Sound(os.path.join(filepath,"sound","click.wav"))
        
        pygame.mixer.music.load(os.path.join(filepath,"sound","music.wav")) #must be wav 16bit and stuff?
...
if __name__ == "__main__":
    filepath = os.path.join("houseReviewData")
    houseReviewMain()
    #pygame.quit() bad for launcher
    #quit() bad for pyinstaller
else:
    filepath = os.path.join("launcherFiles","houseReviewData")
    import sys
