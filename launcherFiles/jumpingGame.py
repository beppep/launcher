...
def jumpingGameMain():
    ...
    class Arena():
        ...
        for i in range(3):
            image = pygame.image.load(os.path.join(filepath,"wall"+str(i+1)+".png"))
        ...
        for i in range(2):
            image = pygame.image.load(os.path.join(filepath,"ground"+str(i+1)+".png"))
    ...
    class Player(Character):
        ...
        for i in range(2):
            image = pygame.image.load(os.path.join(filepath,"blue"+str(i+1)+".png"))
            image = pygame.transform.scale(image, (40, 40))
            blueImages.append(image)
        for i in range(1):
            image = pygame.image.load(os.path.join(filepath,"red"+str(i+1)+".png"))
            image = pygame.transform.scale(image, (40, 40))
...
if __name__=="__main__":
    filepath=os.path.join("jumpingGameFiles")
    jumpingGameMain()
else:
    filepath=os.path.join("launcherFiles","jumpingGameFiles")
    import sys
